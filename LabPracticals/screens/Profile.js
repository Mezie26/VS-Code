...
export default function Profile({ SetisOnboardingCompleted }) {
  ...
  const mykeys = async () => {
    try {
      const allmykeys = await AsyncStorage.getAllKeys();
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.avatarview}>
        <View style={styles.profileimageContainer}>
          {image ? (
            ...
            <Text style={styles.profileimageText}>{firstname.charAt(0)}</Text>
          )}
        </View>
      ...
      <View style={styles.endingview}>
        <Pressable style={styles.discardchangesbutton} onPress={mykeys}>
          <Text style={styles.discardchangestext}>Discard changes</Text>
        </Pressable>
